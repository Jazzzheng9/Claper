defmodule ClaperWeb.EventLive.OpenendComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <div id="extended-openned" style="background-color: rgba(0, 0, 0, 0.7);" class="bg-black w-full py-3 px-6 text-black shadow-lg rounded-md">
        <div class="block w-full h-full cursor-pointer" phx-click={toggle_openend()} phx-target={@myself}>
  ...
  @impl true
  def handle_event("validate", %{"openend_submit" => form_submit_params}, socket) do
    changeset =
      (socket.assigns.current_form_submit || %Claper.Openends.Openend_Submit{})
      |> Claper.Openends.change_form_submit(openend_submit_params)
  ...
  def handle_event(
    ...
    case Claper.Openends.create_or_update_form_submit(
      ...
      {:ok, openend_submit} ->
        ...
        list_openend = Claper.Openends.list_forms(event_id)
  ...
  def handle_event(
    ...
    case Claper.Openends.create_or_update_form_submit(
      ...
      {:ok, openend_submit} ->
        event_id = socket.assigns.event.uuid
        list_form = Claper.Openends.list_forms(event_id)
