...
defprotocol Lti13.Tool.Lti13_User do
  @doc """
  Returns all platform roles for a given user

  ## Examples
      iex> get_platform_roles(%Lti13.Tool.Lti13_User{})
      [%PlatformRole{}]
  """
  ...
  ## Examples
      iex> get_platform_roles(%Lti13.Tool.Lti13_User{}, "issuer-client_id-context_id")
      [%ContextRole{}]
  """
  def get_context_roles(user, context)
end

defimpl Lti13.Tool.Lti13_User, for: Any do
